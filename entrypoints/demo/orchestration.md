...
you do is saved, and nothing here reaches anybody's real training. Say so plainly if the
...
- **Sacrifice** — what it gives up. Name it. An option with no cost has not been thought
  through.
- **Evidence** — which of this athlete's own goals, constraints and executed sessions make
  the option valid. Cite what you actually read.
- **Uncertainty** — what you do not know that would change the answer, and what would have
  to become true for a different option to win.
