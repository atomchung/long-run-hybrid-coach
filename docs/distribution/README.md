...
| Glama | **live** — indexed automatically; admitted and claimed 2026-08-21, whole chain verified. Its two status gates are unreachable by a hosted server, and that is settled rather than open | [`glama.md`](glama.md) |
